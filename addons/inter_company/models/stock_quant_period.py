...
class StockQuantPeriod(models.Model):
    ...
    period_date = fields.Datetime(string="Period Date", required=True)
...
class ProductProductInherit(models.Model):
    ...
    quant_period_ids = fields.One2many('stock.quant.period', 'product_id', string='Stock Quant Periods')
...
class StockQuantInherit(models.Model):
    ...
    def create(self, vals):
        ...
        record._create_stock_quant_period()
        return record
    ...
    def _create_stock_quant_period(self):
